...
public class AndroidApp {
    ...
    private Set<SootMethod> allinterfaces=new HashSet<SootMethod>();
    ...
    public void loadAndroidAPK() {
        //String rtpath="/home/dingli/AppChecker/libs/rt.jar";
        String Path = "/home/dingli/HTTPChecker/oriclasses";
        Options.v().set_src_prec(Options.src_prec_apk);
        Options.v().set_android_jars("/home/dingli/AppChecker/libs");
        Options.v().set_whole_program(true);
        ...
        List<String> stringlist = new LinkedList<String>();
        stringlist.add("/home/dingli/HTTPChecker/testapp.apk");
        Options.v().set_process_dir(stringlist);
        ArrayList<File> filelist = new ArrayList<File>();
        List<SootMethod> entryPoints = new ArrayList<SootMethod>();
        //Options.v().set_omit_excepting_unit_edges(true);
